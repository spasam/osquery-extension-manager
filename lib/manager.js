...
let uuid = null, extensionManager = null, thriftServer = null;
...
async function start(
  ...
  thriftServer = thrift.createServer(Extension, {
    ...
    call: function(registry, name, request) {
      return extensions[registry][name].call(request);
    }
  });
